package com.batonchiksuhoi.tetris.view
...
import com.batonchiksuhoi.tetris.GameActivity
...
import com.batonchiksuhoi.tetris.models.Block
...
class TetrisView : View {
    ...
    fun setGameCommand(move: AppModel.Motions) {
        if(null != model && (model?.curState == AppModel.Statuses.ACTIVE.name)){
